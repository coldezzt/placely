...
namespace Placely.Main.Migrations
{
    ...
    [Migration("20240330170529_seeding_started_messages")]
    partial class seeding_started_messages
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Placely.Data.Entities.Contract", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            LandlordId = 1L,
                            LeaseEndDate = new DateTime(2024, 4, 29, 17, 5, 29, 513, DateTimeKind.Utc).AddTicks(7267),
                            LeaseStartDate = new DateTime(2024, 3, 23, 17, 5, 29, 513, DateTimeKind.Utc).AddTicks(7257),
                            PropertyId = 1L,
                            TenantId = 1L,
                        ...
                        new
                        {
                            Id = 2L,
                            LandlordId = 1L,
                            LeaseEndDate = new DateTime(2024, 4, 13, 17, 5, 29, 513, DateTimeKind.Utc).AddTicks(7274),
                            LeaseStartDate = new DateTime(2024, 3, 30, 17, 5, 29, 513, DateTimeKind.Utc).AddTicks(7274),
                            PropertyId = 2L,
                            TenantId = 2L,
                        ...
                        new
                        {
                            Id = 3L,
                            LandlordId = 2L,
                            LeaseEndDate = new DateTime(2024, 3, 31, 17, 5, 29, 513, DateTimeKind.Utc).AddTicks(7276),
                            LeaseStartDate = new DateTime(2024, 3, 28, 17, 5, 29, 513, DateTimeKind.Utc).AddTicks(7276),
                            PropertyId = 3L,
                            TenantId = 3L,
            ...
            modelBuilder.Entity("Placely.Data.Entities.Message", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ChatId = 1L,
                            Content = "message 1",
                            Date = new DateTime(2024, 3, 28, 17, 5, 29, 513, DateTimeKind.Utc).AddTicks(7368)
                        },
                        new
                        {
                            Id = 2L,
                            ...
                            ChatId = 1L,
                            Content = "message 2",
                            Date = new DateTime(2024, 3, 29, 17, 5, 29, 513, DateTimeKind.Utc).AddTicks(7371)
                        },
                        new
                        {
                            Id = 3L,
                            ...
                            Date = new DateTime(2024, 3, 24, 17, 5, 29, 513, DateTimeKind.Utc).AddTicks(7372),
                            FilePath = "smt"
                        });
                });
            ...
            modelBuilder.Entity("Placely.Data.Entities.PropertyOption", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Placely.Data.Entities.Reservation", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreationDateTime = new DateTime(2024, 3, 10, 17, 5, 29, 513, DateTimeKind.Utc).AddTicks(7299),
                            Duration = new TimeSpan(37, 0, 0, 0, 0),
                            EntryDate = new DateTime(2024, 3, 23, 17, 5, 29, 513, DateTimeKind.Utc).AddTicks(7300),
                            GuestsAmount = (byte)3,
                            LandlordId = 1L,
                            PropertyId = 1L,
                            ReservationStatus = 1,
                        ...
                        {
                            Id = 2L,
                            CreationDateTime = new DateTime(2024, 3, 27, 17, 5, 29, 513, DateTimeKind.Utc).AddTicks(7303),
                            Duration = new TimeSpan(14, 0, 0, 0, 0),
                            EntryDate = new DateTime(2024, 3, 30, 17, 5, 29, 513, DateTimeKind.Utc).AddTicks(7304),
                            GuestsAmount = (byte)1,
                            LandlordId = 1L,
                            PropertyId = 2L,
                            ReservationStatus = 1,
                        ...
                        {
                            Id = 3L,
                            CreationDateTime = new DateTime(2024, 3, 27, 17, 5, 29, 513, DateTimeKind.Utc).AddTicks(7306),
                            Duration = new TimeSpan(3, 0, 0, 0, 0),
                            EntryDate = new DateTime(2024, 3, 28, 17, 5, 29, 513, DateTimeKind.Utc).AddTicks(7307),
                            GuestsAmount = (byte)2,
                            LandlordId = 2L,
                            PropertyId = 3L,
                            ReservationStatus = 1,
                        ...
                        {
                            Id = 4L,
                            CreationDateTime = new DateTime(2024, 3, 30, 17, 5, 29, 513, DateTimeKind.Utc).AddTicks(7308),
                            Duration = new TimeSpan(10, 0, 0, 0, 0),
                            EntryDate = new DateTime(2024, 4, 3, 17, 5, 29, 513, DateTimeKind.Utc).AddTicks(7309),
                            GuestsAmount = (byte)3,
                            LandlordId = 1L,
                            PropertyId = 2L,
                            ReservationStatus = 0,
                        ...
                        {
                            Id = 5L,
                            CreationDateTime = new DateTime(2024, 3, 20, 17, 5, 29, 513, DateTimeKind.Utc).AddTicks(7310),
                            DeclineReason = "too many guests",
                            Duration = new TimeSpan(10, 0, 0, 0, 0),
                            EntryDate = new DateTime(2024, 4, 3, 17, 5, 29, 513, DateTimeKind.Utc).AddTicks(7311),
            ...
            modelBuilder.Entity("PropertyPropertyOption", b =>
                {
                    b.HasOne("Placely.Data.Entities.PropertyOption", null)
                        .WithMany()
