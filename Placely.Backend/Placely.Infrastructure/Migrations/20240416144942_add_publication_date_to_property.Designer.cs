...
namespace Placely.Main.Migrations
{
    ...
    [Migration("20240416144942_add_publication_date_to_property")]
    partial class add_publication_date_to_property
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Placely.Data.Entities.Contract", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            LandlordId = 1L,
                            LeaseEndDate = new DateTime(2024, 5, 16, 14, 49, 41, 849, DateTimeKind.Utc).AddTicks(31),
                            LeaseStartDate = new DateTime(2024, 4, 9, 14, 49, 41, 849, DateTimeKind.Utc).AddTicks(27),
                            PropertyId = 1L,
                            TenantId = 1L
                        },
                        new
                        {
                            Id = 2L,
                            LandlordId = 1L,
                            LeaseEndDate = new DateTime(2024, 4, 30, 14, 49, 41, 849, DateTimeKind.Utc).AddTicks(37),
                            LeaseStartDate = new DateTime(2024, 4, 16, 14, 49, 41, 849, DateTimeKind.Utc).AddTicks(37),
                            PropertyId = 2L,
                            TenantId = 2L
                        },
                        new
                        {
                            Id = 3L,
                            LandlordId = 2L,
                            LeaseEndDate = new DateTime(2024, 4, 17, 14, 49, 41, 849, DateTimeKind.Utc).AddTicks(40),
                            LeaseStartDate = new DateTime(2024, 4, 14, 14, 49, 41, 849, DateTimeKind.Utc).AddTicks(39),
                            PropertyId = 3L,
                            TenantId = 3L
                        });
                });
            ...
            modelBuilder.Entity("Placely.Data.Entities.Message", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ChatId = 1L,
                            Content = "message 1",
                            Date = new DateTime(2024, 4, 14, 14, 49, 41, 849, DateTimeKind.Utc).AddTicks(142)
                        },
                        new
                        {
                            Id = 2L,
                            ...
                            ChatId = 1L,
                            Content = "message 2",
                            Date = new DateTime(2024, 4, 15, 14, 49, 41, 849, DateTimeKind.Utc).AddTicks(145)
                        },
                        new
                        {
                            Id = 3L,
                            ...
                            Date = new DateTime(2024, 4, 10, 14, 49, 41, 849, DateTimeKind.Utc).AddTicks(147),
                            FilePath = "smt"
                        });
                });
            ...
            modelBuilder.Entity("Placely.Data.Entities.Property", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            OwnerId = 1L,
                            PriceListId = 1L,
                            PublicationDate = new DateTime(2024, 4, 15, 14, 49, 41, 848, DateTimeKind.Utc).AddTicks(9952),
                            Rating = 0.0,
                            Type = 2
                        },
                        new
                        {
                            ...
                            OwnerId = 1L,
                            PriceListId = 2L,
                            PublicationDate = new DateTime(2024, 3, 17, 14, 49, 41, 848, DateTimeKind.Utc).AddTicks(9996),
                            Rating = 0.0,
                            Type = 0
                        },
                        new
                        {
                            ...
                            OwnerId = 2L,
                            PriceListId = 3L,
                            PublicationDate = new DateTime(2024, 2, 16, 14, 49, 41, 848, DateTimeKind.Utc).AddTicks(9999),
                            Rating = 0.0,
                            Type = 3
                        });
                });
            ...
            modelBuilder.Entity("Placely.Data.Entities.Reservation", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreationDateTime = new DateTime(2024, 3, 27, 14, 49, 41, 849, DateTimeKind.Utc).AddTicks(65),
                            Duration = new TimeSpan(37, 0, 0, 0, 0),
                            EntryDate = new DateTime(2024, 4, 9, 14, 49, 41, 849, DateTimeKind.Utc).AddTicks(66),
                            GuestsAmount = (byte)3,
                            LandlordId = 1L,
                            PropertyId = 1L,
                            ReservationStatus = 1,
                        ...
                        {
                            Id = 2L,
                            CreationDateTime = new DateTime(2024, 4, 13, 14, 49, 41, 849, DateTimeKind.Utc).AddTicks(69),
                            Duration = new TimeSpan(14, 0, 0, 0, 0),
                            EntryDate = new DateTime(2024, 4, 16, 14, 49, 41, 849, DateTimeKind.Utc).AddTicks(70),
                            GuestsAmount = (byte)1,
                            LandlordId = 1L,
                            PropertyId = 2L,
                            ReservationStatus = 1,
                        ...
                        {
                            Id = 3L,
                            CreationDateTime = new DateTime(2024, 4, 13, 14, 49, 41, 849, DateTimeKind.Utc).AddTicks(71),
                            Duration = new TimeSpan(3, 0, 0, 0, 0),
                            EntryDate = new DateTime(2024, 4, 14, 14, 49, 41, 849, DateTimeKind.Utc).AddTicks(72),
                            GuestsAmount = (byte)2,
                            LandlordId = 2L,
                            PropertyId = 3L,
                            ReservationStatus = 1,
                        ...
                        {
                            Id = 4L,
                            CreationDateTime = new DateTime(2024, 4, 16, 14, 49, 41, 849, DateTimeKind.Utc).AddTicks(73),
                            Duration = new TimeSpan(10, 0, 0, 0, 0),
                            EntryDate = new DateTime(2024, 4, 20, 14, 49, 41, 849, DateTimeKind.Utc).AddTicks(74),
                            GuestsAmount = (byte)3,
                            LandlordId = 1L,
                            PropertyId = 2L,
                            ReservationStatus = 0,
                        ...
                        {
                            Id = 5L,
                            CreationDateTime = new DateTime(2024, 4, 6, 14, 49, 41, 849, DateTimeKind.Utc).AddTicks(76),
                            DeclineReason = "too many guests",
                            Duration = new TimeSpan(10, 0, 0, 0, 0),
                            EntryDate = new DateTime(2024, 4, 20, 14, 49, 41, 849, DateTimeKind.Utc).AddTicks(77),
