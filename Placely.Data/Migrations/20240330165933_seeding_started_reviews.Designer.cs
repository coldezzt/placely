...
namespace Placely.Main.Migrations
{
    ...
    [Migration("20240330165933_seeding_started_reviews")]
    partial class seeding_started_reviews
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Placely.Data.Entities.Contract", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            LandlordId = 1L,
                            LeaseEndDate = new DateTime(2024, 4, 29, 16, 59, 33, 591, DateTimeKind.Utc).AddTicks(8565),
                            LeaseStartDate = new DateTime(2024, 3, 23, 16, 59, 33, 591, DateTimeKind.Utc).AddTicks(8554),
                            PropertyId = 1L,
                            TenantId = 1L,
                        ...
                        new
                        {
                            Id = 2L,
                            LandlordId = 1L,
                            LeaseEndDate = new DateTime(2024, 4, 13, 16, 59, 33, 591, DateTimeKind.Utc).AddTicks(8573),
                            LeaseStartDate = new DateTime(2024, 3, 30, 16, 59, 33, 591, DateTimeKind.Utc).AddTicks(8573),
                            PropertyId = 2L,
                            TenantId = 2L,
                        ...
                        new
                        {
                            Id = 3L,
                            LandlordId = 2L,
                            LeaseEndDate = new DateTime(2024, 3, 31, 16, 59, 33, 591, DateTimeKind.Utc).AddTicks(8575),
                            LeaseStartDate = new DateTime(2024, 3, 28, 16, 59, 33, 591, DateTimeKind.Utc).AddTicks(8575),
                            PropertyId = 3L,
                            TenantId = 3L,
            ...
            modelBuilder.Entity("Placely.Data.Entities.Reservation", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreationDateTime = new DateTime(2024, 3, 10, 16, 59, 33, 591, DateTimeKind.Utc).AddTicks(8598),
                            Duration = new TimeSpan(37, 0, 0, 0, 0),
                            EntryDate = new DateTime(2024, 3, 23, 16, 59, 33, 591, DateTimeKind.Utc).AddTicks(8599),
                            GuestsAmount = (byte)3,
                            LandlordId = 1L,
                            PropertyId = 1L,
                            ReservationStatus = 1,
                        ...
                        {
                            Id = 2L,
                            CreationDateTime = new DateTime(2024, 3, 27, 16, 59, 33, 591, DateTimeKind.Utc).AddTicks(8602),
                            Duration = new TimeSpan(14, 0, 0, 0, 0),
                            EntryDate = new DateTime(2024, 3, 30, 16, 59, 33, 591, DateTimeKind.Utc).AddTicks(8603),
                            GuestsAmount = (byte)1,
                            LandlordId = 1L,
                            PropertyId = 2L,
                            ReservationStatus = 1,
                        ...
                        {
                            Id = 3L,
                            CreationDateTime = new DateTime(2024, 3, 27, 16, 59, 33, 591, DateTimeKind.Utc).AddTicks(8604),
                            Duration = new TimeSpan(3, 0, 0, 0, 0),
                            EntryDate = new DateTime(2024, 3, 28, 16, 59, 33, 591, DateTimeKind.Utc).AddTicks(8605),
                            GuestsAmount = (byte)2,
                            LandlordId = 2L,
                            PropertyId = 3L,
                            ReservationStatus = 1,
                        ...
                        {
                            Id = 4L,
                            CreationDateTime = new DateTime(2024, 3, 30, 16, 59, 33, 591, DateTimeKind.Utc).AddTicks(8607),
                            Duration = new TimeSpan(10, 0, 0, 0, 0),
                            EntryDate = new DateTime(2024, 4, 3, 16, 59, 33, 591, DateTimeKind.Utc).AddTicks(8607),
                            GuestsAmount = (byte)3,
                            LandlordId = 1L,
                            PropertyId = 2L,
                            ReservationStatus = 0,
                        ...
                        {
                            Id = 5L,
                            CreationDateTime = new DateTime(2024, 3, 20, 16, 59, 33, 591, DateTimeKind.Utc).AddTicks(8609),
                            DeclineReason = "too many guests",
                            Duration = new TimeSpan(10, 0, 0, 0, 0),
                            EntryDate = new DateTime(2024, 4, 3, 16, 59, 33, 591, DateTimeKind.Utc).AddTicks(8610),
