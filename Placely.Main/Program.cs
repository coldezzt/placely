...
// TODO: НЕТ КОНТРОЛЛЕРА СОЗДАНИЯ ЗАЯВКИ (РЕЗЕРВАЦИИ)!!!
...
// TODO: добавить метод фильтрования имуществ, убрать сборку делегата - заменить хардкодом, по причине того что EF не умеет разбирать предикат в sql запрос.
